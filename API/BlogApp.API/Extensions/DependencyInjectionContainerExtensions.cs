...
namespace BlogApp.API.Extensions
{
    public static class DependencyInjectionContainerExtensions
    {
        ...
        public static void AddValidators(this IServiceCollection services)
        {
            ...
            services.AddTransient<UserFollowerValidator>();
        }
        public static void AddUseCases(this IServiceCollection services)
        {
            ...
            services.AddRoleUseCasesUseCases();
            services.AddNavigationLinksUseCases();
            services.AddUseCasesUseCases();
            services.AddFollowersUseCases();
        }
        ...
        public static void AddUsersUseCases(this IServiceCollection services)
        {
            ...
            services.AddTransient<IFindUserShortQuery, EfFindUserShortQuery>();
        }
        ...
        public static void AddRoleUseCasesUseCases(this IServiceCollection services)
        {
            services.AddTransient<IUpdateUseCasesCommand, EfUpdateRoleUseCasesCommand>();
        }
       ...
       public static  void AddNavigationLinksUseCases(this IServiceCollection services)
        ...
        public static void AddUseCasesUseCases(this IServiceCollection services)
        {
            services.AddTransient<ICreateUseCasesCommand, EfCreateUseCaseCommand>();
            services.AddTransient<IGetUseCasesQuery, EfGetUseCasesQuery>();
            services.AddTransient<IFindUseCaseQuery, EfFindUseCaseQuery>();
            services.AddTransient<IUpdateUseCaseCommand, EfUpdateUseCaseCommand>();
            services.AddTransient<IDeleteUseCaseCommand, EfDeleteUseCaseComand>();
        }

        public static void AddFollowersUseCases(this IServiceCollection services)
        {
            services.AddTransient<IGetFollowersFollowingQuery, EfGetFollowersFollowingQuery>();
            services.AddTransient<ICreateUserFollowerCommand, EfCreateUserFollowerCommand>();
            services.AddTransient<IDeleteUserFollowerCommand, EfDeleteUserFollowerCommand>();
        }
    }
}
