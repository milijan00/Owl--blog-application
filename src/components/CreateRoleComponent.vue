<template>
 <article class="mb-3">
	<h2 class="post-title">Create new role.</h2>
 </article>
	<article>
...
<ModalComponent v-if="showModal" title="Create  new role" successMessage="You have created a new role." :failureMessage="failureMessage" @hide-modal="showModal = false" :outcome="outcome"></ModalComponent>
</template>
