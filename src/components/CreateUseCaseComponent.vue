<template>
 <article class="mb-3">
	<h2 class="post-title">Create new usecase.</h2>
 </article>
	<article>
...
<ModalComponent v-if="showModal" title="Create  new usecase" successMessage="You have created a new usecase." :failureMessage="failureMessage" @hide-modal="showModal = false" :outcome="outcome"></ModalComponent>
</template>
