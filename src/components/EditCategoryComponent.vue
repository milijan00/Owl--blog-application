<template>
 <article class="mb-3">
	<h2 class="post-title">Edit a category.</h2>
 </article>
	<article>
...
<ModalComponent v-if="showModal" title="Edit a category" successMessage="You have edited  a category." :failureMessage="failureMessage" @hide-modal="showModal = false" :outcome="outcome"></ModalComponent>
</template>
